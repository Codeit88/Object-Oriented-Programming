...
int main() {
	...
	cout << endl;
	b1.wrapper_ite_search(27);
	b1.wrapper_ite_delete_node(64);
	cout << " After Deletion : ";
	b1.wrapper_ite_inorder_print();
	b1.wrapper_Update_Key(27, 101);
	cout << "\n After updation : ";
	b1.wrapper_rec_inorder_print();
	cout << "\n Total nodes are : "<<
	b1.wrapper_nodes_counter();
	b1.wrapper_mirror();
	cout << "\n After taking mirror : ";
	b1.wrapper_rec_levelprint();
	return 0;
